...
HOW TO USE:
Step 1: Download this whole "bioinformatics" folder, and paste it into a directory of your choosing.
Step 2: Open the sequencer.py file to start the program, a GUI will pop up.
Step 3: Find the two-letter enzyme class of your desired enzyme and enter it into the first field.
	KEY:
...
Step 4: Find the family number of your desired enzyme and enter it into the second field.
Step 5: Type the file path of your directory where you put the "bioinformatics" folder. (Example: D:/bioinformatics)
Step 6: Type the file path of your downloads directory. (Example: C:/Users/Igor/Downloads)
	In other words, this is the directory where you get files when you download them off the internet.
Step 7: Hit Enter and wait for all the Chrome windows to open and close. You know the program finished its job when the GUI disappears.
